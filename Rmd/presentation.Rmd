...
- ### Code and documentation in `.Rmd`. 
    - Extract pure code to `.R` using `purl`
- ### Code in `.R`, annotations in `.Rmd`. 
    - `read_chunks()` and call in `.Rmd`
- ### Code in `.R`.
    - use [`roxygen2`](https://cran.r-project.org/web/packages/roxygen2/vignettes/roxygen2.html) annotation + `spin()` -> .html
...
- ### [**`example-rmd2.Rmd`**](https://raw.githubusercontent.com/annakrystalli/lit-prog/master/Rmd/example-rmd2.Rmd)
    ...
    - call the chunks within the `.Rmd`
